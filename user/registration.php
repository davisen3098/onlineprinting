...
function validateFormFields($fields) {
    ...
    if (!isset($errors['password']) && !isset($errors['confirmpassword']) && $_POST['password'] !== $_POST['confirmpassword']) {
...
$requiredFields = ['firstname', 'lastname', 'username', 'password', 'confirmpassword', 'email', 'street', 'town', 'phone'];

if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $errors = validateFormFields($requiredFields);
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-5 p-3">
                            <form method="post">
                                <div class="mb-3">
                                    <label for="firstname" class="form-label d-none">Firstname</label>
                                    <input type="text" class="form-control form-control-md rounded-0" name="firstname" id="firstname" placeholder="Firstname">
                                </div>
                                <div class="mb-3">
                                    <label for="lastname" class="form-label d-none">Lastname</label>
                                    <input type="text" class="form-control form-control-md rounded-0" name="lastname" id="lastname" placeholder="Lastname">
                                </div>
                                <div class="mb-3">
                                    <label for="username" class="form-label d-none">Username</label>
                                    <input type="text" class="form-control form-control-md rounded-0" name="username" id="username" placeholder="Username">
                                </div>
                                <div class="mb-3">
                                    <label for="street" class="form-label d-none">Street</label>
                                    <input type="text" class="form-control form-control-md rounded-0" name="street" id="street" placeholder="Street">
                                </div>
                                <div class="mb-3">
                                    <label for="town" class="form-label d-none">town</label>
                                    <input type="text" class="form-control form-control-md rounded-0" name="town" id="town" placeholder="Town">
                                </div>
                                <div class="mb-3">
                                    <label for="phone" class="form-label d-none">Phone</label>
                                    <input type="tel" class="form-control form-control-md rounded-0" name="phone" id="phone" placeholder="Phone">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="password" class="form-control form-control-md rounded-0" name="password" id="password" placeholder="Password">
                                </div>
                                <div class="mb-3">
                                    <label for="confirmpassword" class="form-label d-none">Confirm Password</label>
                                    <input type="password" class="form-control form-control-md rounded-0" name="confirmpassword" id="confirmpassword" placeholder="Confirm Password">
                                </div>
                                <div class="d-grid gap-2">
                                    <input type="submit" value="Submit" name="submit" class="btn btn-dark btn-md rounded-0">
