...
if (isset($_POST['block'])) {
    $sql = "update customer set cust_status =:cust_status where cust_id =:cust_id";
    $stmt = $db->prepare($sql);
    $params = [
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?= $user['cust_id']; ?></td>
                                                        <td><img src="<?= 'img/' . $user['cust_image']; ?>" alt="" class="img-fluid"></td>
                                                        ...
                                                        <td>
                                                            <form action="" method="post" class="d-inline">
                                                                <input type="hidden" name="cust_id" value="<?= $user['cust_id'] ?>">

                                                                <?php if ($user['cust_status'] == 1) {

                                                                ?>
                                                                    <button type="submit" name="block" value="<?= $user['cust_id'] ?>" class="btn btn-danger btn-sm">Block</button>
                                                                <?php } else { ?>
                                                                    <button type="submit" name="unblock" value="<?= $user['cust_id'] ?>" class="btn btn-success btn-sm">Unblock</button>
                                                                <?php } ?>
                                                            </form>
                                                        </td>
                                                    </tr>
