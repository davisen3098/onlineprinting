...
if (isset($_POST['submit'])) {
    ...
    $option = new Option($name, $day, $price);
    $result = $option->addOption();
                    ...
                    <div class="row justify-content-md-center">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group mt-3">
                                <input type="number" class="form-control" id="option_days" name="option_days" placeholder="Option Days">
                            </div>
                            <div class="form-group mt-3">
                                <input type="text" class="form-control" id="option_price" name="option_price" placeholder="Option Price">
                            </div>
                            <div class="form-group mt-3">
                                <input type="submit" class="btn btn-success form-control" value="Add Option" name="submit">
                            </div>
                        </form>
                        </div>
                    </div>
