                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $option['price']; ?></td>
                                                        <td>
                                                            <a href="editOption.php?id=<?= $option['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                            <!-- <form action="" method="post" class="d-inline">
                                                                <button type="submit" name="delete_option" value="<?= $option['id']; ?>" class="btn btn-danger btn-sm">Delete</button>
                                                            </form> -->
                                                        </td>
                                                    </tr>
                                            <?php
