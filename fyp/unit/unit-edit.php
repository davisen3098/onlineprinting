...
if (isset($_GET['id'])) {
    $unit_id = $_GET['id'];
    $dbh = new DB_con();
    $query_run = $dbh->getUnitBy($unit_id);
...
if (isset($_POST['update_unit'])) {
    if (preg_match('/^[a-zA-Z ]*$/', $_POST['unit_name'])) {
        $result = $update_db->updateUnit($unit_id, $_POST['unit_name']);
        if ($result) {
        ...
        echo "<script>alert('Only letters are accepted')</script>";
    }
}
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row justify-content-md-center">
                        <div class="col-md-8">
                            <h1 class="mt-4 text-center">Update unit </h1>
                        </div>
                    </div>
                    <div class="row justify-content-md-center">
                        <div class="col-md-8">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="unit_name" name="unit_name" placeholder="Unit name" value="<?= $unit_name ?>">
                                </div>
                                <div class="form-group mt-3">
                                    <input type="submit" class="btn btn-success form-control" value="Update unit" name="update_unit" />
                                </div>
                            </form>
                            </form>
