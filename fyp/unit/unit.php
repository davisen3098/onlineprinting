...
if (isset($_POST['submit'])) {
    ...
    $result = $db->addUnit($unit_name);

    if ($result) {
        echo "<script>alert('Unit successfully added')</script>";
    } else {
        echo "<script>alert('Unit name already exists')</script>";
    }
}
                        ...
                        <div class="col-md-8">
                            <form action="" method="post">
                                ...
                                <div class="form-group mt-3">
                                    <input type="submit" class="btn btn-success form-control" value="Add unit" name="submit" />
                                </div>
                            </form>
                        </div>
                    </div>
