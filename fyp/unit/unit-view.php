                                         ...
                                         <?php
                                            ...
                                            ?>
                                                 <tr>
                                                     ...
                                                     <td>
                                                         <a href="unit-edit.php?id=<?= $unit['unit_id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                         <!-- <form action="" method="post" class="d-inline">
                                                             <button type="submit" name="delete_unit" value="<?= $unit['unit_id']; ?>" class="btn btn-danger btn-sm">Delete</button>
                                                         </form> -->
                                                     </td>
                                                 </tr>
                                         <?php
