                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            include_once('../connection.php');
                                            $dbe = new DB_con();
                                            $query_run = $dbe->getAllStock();

                                            if (mysqli_num_rows($query_run) > 0) {
                                                foreach ($query_run as $stock) {
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><img src="<?= '../img/' . $stock['file_name']; ?>" alt="" class="img-fluid"></td>
                                                        <td>
                                                            <a href="stock-edit.php?id=<?= $stock['stock_id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                            <!-- <form action="" method="post" class="d-inline">
                                                        <button type="submit" name="delete_category" value="<?= $stock['stock_id']; ?>" class="btn btn-danger btn-sm">Delete</button>
                                                    </form> -->
                                                        </td>
                                                    </tr>
                                            <?php
