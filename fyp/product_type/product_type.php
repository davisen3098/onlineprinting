...
/**
 * todo: real-time validation of unit name
 * todo: change alert messages
 */

if (isset($_POST['submit'])) {
    if (isset($_POST['pt_name']) && !empty($_POST['pt_name'])) {
        $regex = '/^[a-zA-Z\s]*$/';
        $pt_name = $_POST['pt_name'];
        if (preg_match($regex, $pt_name)) {
            $db = new DB_con();
            $result = $db->addProductType($pt_name);
            if ($result) {
            ...
            <main>
                <div class="container-fluid px-4">
                    <div class="row justify-content-md-center">
                        <div class="col-md-8">
                            <h1 class="mt-4">Add new Product type</h1>
                        </div>
                    </div>
                    <div class="row justify-content-md-center">
                        <div class="col-md-8">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="pt_name" name="pt_name" placeholder="Product type name">
                                </div>
                                <div class="form-group mt-3">
                                    <input type="submit" class="btn btn-success form-control" value="Add Product Type" name="submit" />
                                </div>
                            </form>
                        </div>
                    </div>
