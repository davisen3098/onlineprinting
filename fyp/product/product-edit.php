...
if (isset($_POST['update_product'])) {
    $result = $update_db->updateProduct($p_id, $_POST['p_name'], $_POST['p_desc'], $_POST['pt_dropdown'], $_POST['category']);
    if ($result) {
                        ...
                        <div class="col-md-8">
                            <form action="" method="post">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="p_name" name="p_name" placeholder="Product name" value="<?= $p_name ?>">
                                </div>
                                <div class="form-group mt-3">
                                    <textarea placeholder="Description" id="p_desc" name="p_desc" class="form-control"><?= $p_desc ?></textarea>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    <input type="submit" class="btn btn-success form-control" value="Update product" name="update_product" />
                                </div>
                            </form>
                            </form>
