                                             ...
                                             <?php
                                                ...
                                                ?>
                                                     <tr>
                                                         ...
                                                         <td>
                                                             <a href="color-edit.php?id=<?= $color['color_id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                                             <form action="" method="post" class="d-inline">
                                                                 <button type="submit" name="delete_color" value="<?= $color['color_id']; ?>" class="btn btn-danger btn-sm">Delete</button>
                                                             </form>
                                                         </td>
                                                     </tr>
                                             <?php
