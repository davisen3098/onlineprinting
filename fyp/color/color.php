...
//     $result = $db->addColor($color_name);

//     if ($result) {
//         echo "<script>alert('Color successfully added')</script>";
//     } else {
                        ...
                        <div class="col-md-8">
                            <form action="" method="post">
                                ...
                                <div class="form-group mt-3">
                                    <input type="submit" class="btn btn-success form-control" value="Add color" name="submit" />
                                </div>
                            </form>
                        </div>
                    </div>
